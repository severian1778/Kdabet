...
config :kdabet_frontend, KdabetFrontendWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: KdabetFrontendWeb.ErrorHTML, json: KdabetFrontendWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: KdabetFrontend.PubSub,
  live_view: [signing_salt: "2K82SAF+"]
...
config :kdabet_frontend, KdabetFrontend.Mailer, adapter: Swoosh.Adapters.Local
