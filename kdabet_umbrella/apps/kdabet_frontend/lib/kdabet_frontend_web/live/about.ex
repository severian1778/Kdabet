defmodule KdabetFrontendWeb.About do
  ...
  def render(assigns) do
    ~F"""
    <div class="flex flex-col xl:flex-row w-full h-fit overflow-hidden">
      <!-- About us -->
      <section class="fader w-full md:w-5/6 lg:w-5/6 xl:w-1/2 justify-center mx-auto xl:justify-start h-full overflow-hidden invisible-scroll overflow-y-scroll">
