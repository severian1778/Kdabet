    ...
    <div class="flex flex-col xl:flex-row w-full h-fit xl:h-[85vh] overflow-hidden">
      ...
      <section class="fader mt-5 w-full md:w-5/6 lg:w-5/6 xl:w-1/2 justify-center m-auto xl:justify-start h-full overflow-hidden invisible-scroll overflow-y-scroll">
        <article class="glasscard p-[20px] md:p-[30px] lg:p-[50px] mt-[20px]">
          <h2 class="glowtext mb-8 text-2xl">Web3's first purely decentralized prediction market.</h2>
          ...
          <p class="glowtext mb-3">The KDAbet platform is the first prediction market of its kind, where the operation has no owners, board of directors, company structure or token.  The automated bookmaking system is overseen only via a decentralized autonomous organization (DAO) that collectivizes its programmatic progression over time via a fair vote.</p>
        ...
        <article class="glasscard block md:hidden mt-10 p-[20px] md:p-[30px] lg:p-[50px]">
