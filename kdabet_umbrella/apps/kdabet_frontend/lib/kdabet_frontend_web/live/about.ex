defmodule KdabetFrontendWeb.About do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col xl:flex-row w-full h-fit xl:h-[85vh] overflow-hidden">
      <!-- About us -->
      <section class="fader w-full md:w-5/6 lg:w-5/6 xl:w-1/2 justify-center m-auto xl:justify-start h-full overflow-hidden invisible-scroll overflow-y-scroll">
        <h2 class="fade_title w-full mt-5 xl:mt-0 text-center xl:lg:text-left pb-5 text-[3em] md:text-[4em] xl:text-[5.5em]">ABOUT US</h2>
