...
(define-keyset "free.kdabet_admin" (read-keyset "kdabet-admin"))
(define-keyset "free.kdabet_operation" (read-keyset "kdabet-operation"))
...
(module kingsmint GOVERNANCE
  ...
  (defcap GOVERNANCE ()
    (enforce-guard (keyset-ref-guard "free.kdabet_admin" ))
  ...
  (defcap OPS()
    (enforce-guard (keyset-ref-guard "free.kdabet_operation"))
  ...
  (defcap WLCREATOR:bool (collection:string)
    ...
    (util.guards.enforce-or creatorGuard  (keyset-ref-guard "free.kdabet_operation") ))
